...
% V2 = zeros(N,1); %vector del V2 Nfilas 1Columna
% V3 = zeros(N,1); %vector del V3 Nfilas 1Columna
% V4 = zeros(N,1); %vector del V4 Nfilas 1Columna
% V5 = zeros(N,1); %vector del V5 Nfilas 1Columna
% V6 = zeros(N,1); %vector del V6 Nfilas 1Columna
% V7 = zeros(N,1); %vector del V7 Nfilas 1Columna
% V8 = zeros(N,1); %vector del V8 Nfilas 1Columna
% V9 = zeros(N,1); %vector del V9 Nfilas 1Columna
% V10= zeros(N,1); %vector del V10 Nfilas 1Columna
% V11= zeros(N,1); %vector del V11 Nfilas 1Columna
% V12= zeros(N,1); %vector del V12 Nfilas 1Columna
% V13= zeros(N,1); %vector del V13 Nfilas 1Columna
% V14= zeros(N,1); %vector del V14 Nfilas 1Columna
% V15= zeros(N,1); %vector del V15 Nfilas 1Columna
% V16= zeros(N,1); %vector del V16 Nfilas 1Columna
...
Voltajes = [t;V1']; %agregar los otros 15 voltajes
